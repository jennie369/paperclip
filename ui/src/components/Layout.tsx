      ...
      <div className={cn("min-h-0 flex-1", isMobile ? "w-full" : "flex overflow-hidden")}>
        ...
        {isMobile ? (
          ...
          <div className="flex h-full shrink-0">
            ...
            <div
              className={cn(
                "flex flex-col overflow-hidden transition-[width] duration-100 ease-out bg-background",
                sidebarOpen ? "w-60" : "w-0"
              )}
            >
              <div className="flex-1 min-h-0 w-60 border-r border-border flex flex-col">
                {isInstanceSettingsRoute ? <InstanceSidebar /> : <Sidebar />}
              </div>
              <div className="border-t border-r border-border px-3 py-2 shrink-0 w-60 bg-background">
                <div className="flex items-center gap-1">
                  <a
                    href="https://docs.paperclip.ing/"
                    target="_blank"
