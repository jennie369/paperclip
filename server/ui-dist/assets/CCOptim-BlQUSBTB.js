import { o as createLucideIcon, r as reactExports, cK as Route, ai as Network, cL as FingerprintPattern, V as Target, cM as FlaskConical, aw as Brain, cN as Radio, cO as MonitorPlay, Z as Zap, w as Layers, cP as Cog, cA as Cpu, t as TriangleAlert, cQ as Tag, b4 as Link2, ac as Copy, H as MessageSquare, E as Eye, cR as Keyboard, cS as Command, bp as Palette, b_ as Smartphone, c7 as GripVertical, a2 as Download, cT as Webhook, cU as Archive, a4 as Globe, b2 as Timer, cV as Server, au as Database, B as BookOpen, be as Hash, f as Type, j as jsxRuntimeExports, y as Search, z as CCSelect, bj as ChevronDown, K as ChevronRight, cW as ListChecks, l as TrendingUp, C as CircleCheckBig, c as Clock, ad as CircleDot } from './index-C7HOhyqm.js';
import { S as Scissors } from './scissors-Bsr4H421.js';
import { H as HardDrive } from './hard-drive-evO0bd_f.js';
import { Y as Youtube, C as ChartPie } from './youtube-LGWZSHDJ.js';
...
function getStatusConfig(status) {
  switch (status) {
    case "done":
      return { label: "Hoàn Thành", className: "bg-emerald/10 text-emerald", icon: CircleCheckBig };
    case "in-progress":
...
function OverallProgressBar({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card p-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "font-heading text-sm font-semibold text-txt flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingUp, { size: 16, className: "text-gold" }),
        "Tiến Độ Tổng Thể"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-sm font-heading font-bold text-gold", children: [
        done,
        "/",
        total,
        " hoàn thành"
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full bg-bg-4 rounded-full h-3 overflow-hidden mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "h-full flex", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-6 text-xs", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheckBig, { size: 12, className: "text-emerald" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-txt-2", children: [
          done,
          " Hoàn Thành"
        ] })
      ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CircleDot, { size: 12, className: "text-purple" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-txt-2", children: [
          planned,
          " Dự Kiến"
        ] })
...
function CategoryProgressBar({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 bg-bg-4 rounded-full h-1.5 overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "h-full flex", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-emerald h-full", style: { width: `${donePct}%` } }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-gold h-full", style: { width: `${inProgressPct}%` } })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xxs text-txt-3 w-12 text-right", children: [
      done,
      "/",
      total
    ] })
...
function OptimizationCard({ optim }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4 rounded-card bg-glass-bg border border-border hover:border-border-2 transition-all", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded flex items-center justify-center bg-bg-4 shrink-0 mt-0.5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { size: 16, className: "text-txt-2" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-2 mb-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-xs font-semibold text-txt", children: optim.name }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 shrink-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-xxs px-1.5 py-0.5 rounded-badge ${priorityCfg.className}`, children: priorityCfg.label }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: `text-xxs px-1.5 py-0.5 rounded-badge flex items-center gap-1 ${statusCfg.className}`, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(StatusIcon, { size: 10 }),
            statusCfg.label
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xxs text-txt-3 leading-relaxed", children: optim.description })
    ] })
  ] }) });
}
function OptimizationsPage() {
  ...
  const allOptims = reactExports.useMemo(
  ...
  const filteredCategories = reactExports.useMemo(() => {
    return CATEGORIES.map((cat) => ({
      ...
      optimizations: cat.optimizations.filter((o) => {
        ...
        const matchSearch = !searchQuery || o.name.toLowerCase().includes(searchQuery.toLowerCase()) || o.description.toLowerCase().includes(searchQuery.toLowerCase());
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6 animate-fade-in", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "font-heading text-2xl font-bold text-txt flex items-center gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Zap, { size: 24, className: "text-gold" }),
          "37 Tối Ưu Hoá"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-txt-3 mt-1", children: "7 danh mục, 37 tối ưu hoá cho GEM Content Control Center" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: expandAll, className: "btn btn-gh text-xs", children: "Mở tất cả" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: collapseAll, className: "btn btn-gh text-xs", children: "Đóng tất cả" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      OverallProgressBar,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-7 gap-2", children: CATEGORIES.map((cat) => {
      const Icon = cat.icon;
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { size: 18, className: `${cat.color} mx-auto mb-1.5` }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xxs text-txt-2 font-medium mb-1 leading-tight", children: cat.name }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs font-heading font-bold text-txt", children: [
              done,
              "/",
              total
            ] })
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        CCSelect,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "done", children: "Hoàn Thành" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "in-progress", children: "Đang Làm" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "planned", children: "Dự Kiến" })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        CCSelect,
        {
          ...
          className: "text-xs",
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "all", children: "Tất cả ưu tiên" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "critical", children: "Cực Kỳ Quan Trọng" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "high", children: "Cao" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "medium", children: "Trung Bình" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "low", children: "Thấp" })
          ]
        }
      ),
      (filterStatus !== "all" || filterPriority !== "all" || searchQuery) && /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          onClick: () => {
            setFilterStatus("all");
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: filteredCategories.map((cat) => {
      const Icon = cat.icon;
      const isExpanded = expandedCategories.has(cat.id);
      const originalCat = CATEGORIES.find((c) => c.id === cat.id);
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { id: `cat-${cat.id}`, className: "card overflow-hidden", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            children: [
              isExpanded ? /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronDown, { size: 16, className: "text-txt-3 shrink-0" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronRight, { size: 16, className: "text-txt-3 shrink-0" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-card bg-bg-4 flex items-center justify-center shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { size: 18, className: originalCat.color }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-sm font-semibold text-txt", children: originalCat.name }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xxs text-txt-3", children: [
                    "(",
                    cat.optimizations.length,
                    " tối ưu hoá)"
                  ] })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xxs text-txt-3", children: originalCat.description })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-32 shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CategoryProgressBar, { category: originalCat }) })
            ]
          }
        ),
        isExpanded && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4 pt-0 space-y-2", children: cat.optimizations.map((optim) => /* @__PURE__ */ jsxRuntimeExports.jsx(OptimizationCard, { optim }, optim.id)) })
      ] }, cat.id);
    }) }),
    filteredCategories.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card p-12 text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Search, { size: 48, className: "mx-auto mb-4 text-txt-3" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-txt-2 mb-1", children: "Không tìm thấy tối ưu hoá nào" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-txt-3", children: "Thử thay đổi bộ lọc hoặc từ khoá tìm kiếm" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4 border-b border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "font-heading text-sm font-semibold text-txt flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(ListChecks, { size: 16, className: "text-gold" }),
        "Bảng Tổng Hợp"
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-b border-border bg-glass-bg", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left text-xxs text-txt-3 font-medium p-3", children: "Danh Mục" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-center text-xxs text-txt-3 font-medium p-3", children: "Tổng" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-center text-xxs text-txt-3 font-medium p-3", children: "Hoàn Thành" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-center text-xxs text-txt-3 font-medium p-3", children: "Đang Làm" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-center text-xxs text-txt-3 font-medium p-3", children: "Dự Kiến" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-center text-xxs text-txt-3 font-medium p-3", children: "Tỉ Lệ" })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("tbody", { children: [
          CATEGORIES.map((cat) => {
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-b border-border last:border-0 hover:bg-glass-bg transition-all", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "p-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { size: 14, className: cat.color }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-txt font-medium", children: cat.name })
              ] }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "p-3 text-center text-xs text-txt-2", children: total }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "p-3 text-center text-xs text-emerald", children: done }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "p-3 text-center text-xs text-gold", children: inProg }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "p-3 text-center text-xs text-purple", children: planned }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "p-3 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: `text-xs font-medium ${pct === 100 ? "text-emerald" : pct >= 50 ? "text-gold" : "text-txt-3"}`, children: [
                pct,
                "%"
              ] }) })
            ] }, cat.id);
          }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "bg-glass-bg font-semibold", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "p-3 text-xs text-txt", children: "Tổng Cộng" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "p-3 text-center text-xs text-txt", children: allOptims.length }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "p-3 text-center text-xs text-emerald", children: totalDone }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "p-3 text-center text-xs text-gold", children: totalInProgress }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "p-3 text-center text-xs text-purple", children: totalPlanned }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "p-3 text-center text-xs text-gold", children: [
...
export { OptimizationsPage as default };
