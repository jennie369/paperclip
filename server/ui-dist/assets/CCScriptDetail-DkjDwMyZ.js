...
function ScriptDetailContent() {
  ...
  reactExports.useEffect(() => {
    (async () => {
      try {
        const { getSupabase } = await __vitePreload(async () => { const { getSupabase } = await import('./index-DE6uMbR4.js').then(n => n.dq);return { getSupabase }},true              ?__vite__mapDeps([0,1]):void 0);
  ...
  const handleIterate = reactExports.useCallback(async (instruction) => {
    ...
    setIterateInput("");
    try {
      const { generationJobService } = await __vitePreload(async () => { const { generationJobService } = await import('./generationJobService-CAxaf05z.js');return { generationJobService }},true              ?__vite__mapDeps([2,0,1]):void 0);
    ...
    async (newStatus) => {
      ...
      try {
        if (newStatus === "approved") {
          const { opsApi } = await __vitePreload(async () => { const { opsApi } = await import('./index-DE6uMbR4.js').then(n => n.dr);return { opsApi }},true              ?__vite__mapDeps([0,1]):void 0);
...
Footer: "gemral.com" centered`;
  ...
  const handlePublishNews = reactExports.useCallback(async (pubStatus) => {
    ...
    try {
      ...
      let imageUrls = [];
      if (uploadedImages.length > 0) {
        const { getSupabase: getCCSupabase } = await __vitePreload(async () => { const { getSupabase: getCCSupabase } = await import('./index-DE6uMbR4.js').then(n => n.dq);return { getSupabase: getCCSupabase }},true              ?__vite__mapDeps([0,1]):void 0);
      ...
      if (pubStatus === "published") {
        try {
          const { supabase: gemralSupabase } = await __vitePreload(async () => { const { supabase: gemralSupabase } = await import('./index-DE6uMbR4.js').then(n => n.dp);return { supabase: gemralSupabase }},true              ?__vite__mapDeps([0,1]):void 0);
