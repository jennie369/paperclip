import { aC as getSupabase, dd as TERM_CONVERSIONS, bx as claudeService, de as vietnameseNLP, df as brandVoiceChecker } from './index-CvPgjxWl.js';
export { dg as getSupabaseAdmin, dh as useAppStore } from './index-CvPgjxWl.js';
import { c as calendarService } from './calendarService-j5T-E8ox.js';
export { generationJobService } from './generationJobService-DDLuXXC8.js';
export { a as analyticsAI, y as youtubeService } from './youtubeService-CZbanrbC.js';
...
const PILLAR_DESCRIPTIONS = {
  spiritual: "Trụ cột Nghiên Cứu: năng lượng, tần số, thiền định, chữa lành, chiêm tinh.",
