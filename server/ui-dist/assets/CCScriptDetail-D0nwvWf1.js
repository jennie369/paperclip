const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/generationJobService-CpCNVot9.js","assets/index-DY_auHjr.js","assets/index-BIl5xKwM.css"])))=>i.map(i=>d[i]);
import { o as createLucideIcon, j as jsxRuntimeExports, r as reactExports, k as LoaderCircle, ce as useParams, cf as useSearchParams, ae as useNavigate, bl as useToast, cg as useScript, ch as useSocialPost, ci as useUpdateScript, cj as useUpdateSocialPost, _ as __vitePreload, a4 as Globe, C as CircleCheckBig, n as Send, ck as ArrowLeft, bm as Card, t as TriangleAlert, bc as Button, F as FileText, c1 as Pencil, c as Clock, bg as Badge, E as Eye, P as PenLine, cl as History, ab as Check, ac as Copy, a2 as Download, bi as ChevronUp, bj as ChevronDown, a3 as Monitor, aA as Save, X, a6 as Shield, Z as Zap, B as BookOpen, d as Sparkles, bh as ProgressBar, I as Image, bR as Upload, e as Share2, b3 as CircleCheck, x as ExternalLink, z as CCSelect, m as Mail, bT as Newspaper, cm as CalendarPlus, cn as JobLogViewerPanel } from './index-DY_auHjr.js';
...
function ScriptDetailContent() {
  ...
  const handleIterate = reactExports.useCallback(async (instruction) => {
    ...
    setIterateInput("");
    try {
      const { generationJobService } = await __vitePreload(async () => { const { generationJobService } = await import('./generationJobService-CpCNVot9.js');return { generationJobService }},true              ?__vite__mapDeps([0,1,2]):void 0);
    ...
    async (newStatus) => {
      ...
      try {
        if (newStatus === "approved") {
          const { opsApi } = await __vitePreload(async () => { const { opsApi } = await import('./index-DY_auHjr.js').then(n => n.dk);return { opsApi }},true              ?__vite__mapDeps([1,2]):void 0);
...
Footer: "gemral.com" centered`;
  ...
  const handlePublishNews = reactExports.useCallback(async (pubStatus) => {
    ...
    try {
      const { getSupabase } = await __vitePreload(async () => { const { getSupabase } = await import('./index-DY_auHjr.js').then(n => n.dl);return { getSupabase }},true              ?__vite__mapDeps([1,2]):void 0);
      const supabase = getSupabase();
      let articleContent = mainContent;
      let imageUrls = [];
      if (uploadedImages.length > 0) {
        const { getSupabase: getCCSupabase } = await __vitePreload(async () => { const { getSupabase: getCCSupabase } = await import('./index-DY_auHjr.js').then(n => n.dl);return { getSupabase: getCCSupabase }},true              ?__vite__mapDeps([1,2]):void 0);
      ...
      if (pubStatus === "published") {
        try {
          const { supabase: gemralSupabase } = await __vitePreload(async () => { const { supabase: gemralSupabase } = await import('./index-DY_auHjr.js').then(n => n.dj);return { supabase: gemralSupabase }},true              ?__vite__mapDeps([1,2]):void 0);
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-5 py-3 border-b border-border flex-wrap gap-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
            ...
            showExportMenu && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute right-0 top-full mt-1 p-1 rounded-card bg-glass-bg border border-border space-y-0.5 z-10 min-w-[140px]", children: [
