const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-C5Qt9Trz.js","assets/index-CE_nv2eE.css"])))=>i.map(i=>d[i]);
import { u as useDashboardStats, b as useRecentActivity, F as FileText, C as CircleCheckBig, c as Clock, P as PenLine, j as jsxRuntimeExports, L as LayoutDashboard, R as RefreshCw, d as Sparkles, B as BookOpen, U as Users, e as Share2, f as Type, I as Image, g as Calendar, h as Link, A as ArrowRight, i as Activity, k as LoaderCircle, l as TrendingUp, r as reactExports, _ as __vitePreload, m as Mail, n as Send, D as DollarSign } from './index-C5Qt9Trz.js';
import { F as Film } from './film-tabdwh9E.js';
import { T as TrendingDown } from './trending-down-C-fZIpft.js';
import { M as MousePointer } from './mouse-pointer-BzQ1abQA.js';
...
function EmailKPISection() {
  ...
  async function loadEmailKPIs() {
    try {
      const { getSupabase } = await __vitePreload(async () => { const { getSupabase } = await import('./index-C5Qt9Trz.js').then(n => n.dq);return { getSupabase }},true              ?__vite__mapDeps([0,1]):void 0);
