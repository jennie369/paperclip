const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-DY_auHjr.js","assets/index-BIl5xKwM.css"])))=>i.map(i=>d[i]);
import { u as useDashboardStats, b as useRecentActivity, F as FileText, C as CircleCheckBig, c as Clock, P as PenLine, j as jsxRuntimeExports, L as LayoutDashboard, R as RefreshCw, d as Sparkles, B as BookOpen, U as Users, e as Share2, f as Type, I as Image, g as Calendar, h as Link, A as ArrowRight, i as Activity, k as LoaderCircle, l as TrendingUp, r as reactExports, _ as __vitePreload, m as Mail, n as Send, D as DollarSign } from './index-DY_auHjr.js';
import { F as Film } from './film-CAZv3q0W.js';
import { T as TrendingDown } from './trending-down-jAqRZw5o.js';
import { M as MousePointer } from './mouse-pointer-CTweBZs3.js';
...
function EmailKPISection() {
  ...
  async function loadEmailKPIs() {
    try {
      const { getSupabase } = await __vitePreload(async () => { const { getSupabase } = await import('./index-DY_auHjr.js').then(n => n.dl);return { getSupabase }},true              ?__vite__mapDeps([0,1]):void 0);
