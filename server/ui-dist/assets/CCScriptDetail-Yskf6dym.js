...
function ScriptDetailContent() {
  ...
  const handleIterate = reactExports.useCallback(async (instruction) => {
    ...
    setIterateInput("");
    try {
      const { generationJobService } = await __vitePreload(async () => { const { generationJobService } = await import('./generationJobService-CSptBprE.js');return { generationJobService }},true              ?__vite__mapDeps([0,1,2]):void 0);
    ...
    async (newStatus) => {
      ...
      try {
        if (newStatus === "approved") {
          const { opsApi } = await __vitePreload(async () => { const { opsApi } = await import('./index-DNX_Fd1q.js').then(n => n.dl);return { opsApi }},true              ?__vite__mapDeps([1,2]):void 0);
...
Footer: "gemral.com" centered`;
  ...
  const handlePublishNews = reactExports.useCallback(async (pubStatus) => {
    ...
    try {
      const { getSupabase } = await __vitePreload(async () => { const { getSupabase } = await import('./index-DNX_Fd1q.js').then(n => n.dk);return { getSupabase }},true              ?__vite__mapDeps([1,2]):void 0);
      const supabase = getSupabase();
      let articleContent = mainContent;
      let imageUrls = [];
      if (uploadedImages.length > 0) {
        const { getSupabase: getCCSupabase } = await __vitePreload(async () => { const { getSupabase: getCCSupabase } = await import('./index-DNX_Fd1q.js').then(n => n.dk);return { getSupabase: getCCSupabase }},true              ?__vite__mapDeps([1,2]):void 0);
      ...
      if (pubStatus === "published") {
        try {
          const { supabase: gemralSupabase } = await __vitePreload(async () => { const { supabase: gemralSupabase } = await import('./index-DNX_Fd1q.js').then(n => n.dj);return { supabase: gemralSupabase }},true              ?__vite__mapDeps([1,2]):void 0);
