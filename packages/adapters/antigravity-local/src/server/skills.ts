...
// agy shares the Gemini CLI config home (~/.gemini), including the skills dir.
...
async function buildAntigravitySkillSnapshot(config: Record<string, unknown>): Promise<AdapterSkillSnapshot> {
  ...
  return buildPersistentSkillSnapshot({
    ...
    missingDetail: "Configured but not currently linked into the Antigravity (~/.gemini) skills home.",
